...
def compute_sparse_reward(self, action) -> float:
    ...
    # Minor reward for reducing the distance to the handle
    reward += 0.1 * (1 - np.tanh(10 * distance_to_handle))
    ...
    if distance_to_handle < 0.1:  # If the end-effector is close enough to the handle
        ...
        if is_grasped:
            # Minor reward for successful grasp
            reward += 0.2
            ...
            # Minor reward for rotating the handle towards the target
