...
def compute_dense_reward(self, action) -> float:
    ...
    # Use a sigmoid function to smoothly transition the reward as the distance decreases
    ...
    if distance_to_handle < 0.1:  # If the end-effector is close enough to the handle
        ...
        if is_grasped:
            ...
            # Use a linear reward based on the progress of rotation
    ...
    # Penalize large actions to encourage smoother control
