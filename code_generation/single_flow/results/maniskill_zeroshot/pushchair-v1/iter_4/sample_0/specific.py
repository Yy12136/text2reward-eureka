...
def compute_dense_reward(self, action) -> float:
    ...
    # Stage 8: Chair Stability During Movement
    # Penalize any tilt and angular velocity of the chair during movement
    if dist_to_target >= 0.1:
        reward += -0.2 * chair_tilt - 0.1 * chair_angular_velocity
