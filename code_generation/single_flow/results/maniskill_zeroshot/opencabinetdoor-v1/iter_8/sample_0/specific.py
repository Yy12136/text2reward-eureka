...
def compute_dense_reward(self, action) -> float:
    ...
    # Additional milestone: Penalize collision with the cabinet
    # Check if the robot is colliding with the cabinet
    if self.agent.check_collision(self.cabinet):
        reward += -0.5  # Penalize collision with the cabinet
