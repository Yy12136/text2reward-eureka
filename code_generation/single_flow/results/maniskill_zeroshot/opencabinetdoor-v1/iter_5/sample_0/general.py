...
def compute_sparse_reward(self, action) -> float:
    ...
    # Milestone 1: Task completion (primary focus)
    if cabinet_qpos >= target_qpos:
        reward += 1.0  # Large reward for task completion
        return reward  # Return immediately once the task is completed
    ...
    # Milestone 3: Grasping the handle (prerequisite for opening the door)
    ...
    # Milestone 4: Approaching the cabinet (prerequisite for grasping)
