...
def compute_dense_reward(self, action) -> float:
    ...
    if drawer_qpos > 0.1 * target_qpos:
    ...
    # Additional reward for smooth movement
    # Penalize high velocity of the drawer to encourage smooth pulling
    drawer_velocity = self.target_link.qvel
    velocity_penalty = -0.1 * np.abs(drawer_velocity)
