...
def compute_dense_reward(self, action) -> float:
    ...
    # Additional reward for smooth pulling
    if drawer_qpos > 0.5 * target_qpos:  # If the drawer is halfway opened
        reward += 1.0  # Milestone reward for halfway opening the drawer
    ...
    base_movement_penalty = -0.05 * np.linalg.norm(self.agent.base_velocity)
