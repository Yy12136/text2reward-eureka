...
def compute_dense_reward(self, action) -> float:
    ...
    # Step 2: Align Gripper with Cube A
    # Calculate the alignment error between the gripper and Cube A
    alignment_error = np.linalg.norm(ee_pose_wrt_cubeA.p[2])  # Z-axis alignment
    alignment_reward = -alignment_error
    reward += alignment_reward * 0.2  # Weight for alignment stage
    ...
    # Step 6: Regularization of Robot Action
