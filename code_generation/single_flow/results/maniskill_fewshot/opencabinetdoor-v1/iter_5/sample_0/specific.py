...
def compute_dense_reward(self, action) -> float:
    ...
    # Milestone: Reward for maintaining a stable end-effector position
    ee_position_diff = np.linalg.norm(self.robot.ee_pose.p - self.robot.initial_ee_pose.p)
    ee_stability_reward = 1 - np.tanh(5.0 * ee_position_diff)
