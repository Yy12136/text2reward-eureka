...
def compute_dense_reward(self, action) -> float:
    ...
    # Step 14: Reward for maintaining a stable grasp during placement
    if self.robot.check_grasp(self.cubeA, max_angle=30) and cubeA_to_cubeB_dist < 0.05:
        reward += 0.1 * (1 - np.linalg.norm(self.cubeA.velocity))  # Reward for stable grasp during placement
