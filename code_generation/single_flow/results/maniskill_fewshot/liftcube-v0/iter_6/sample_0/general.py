...
def compute_sparse_reward(self, action) -> float:
    ...
    if tcp_to_cubeA_dist < 0.05:  # Threshold for reaching the cube
        ...
        if is_grasped:
            ...
            if cubeA_height >= self.goal_height:  # Threshold for lifting to the goal height
                reward += 10.0  # Reward for successfully lifting the cube
                ...
                if is_cubeA_static and is_robot_static:
                    reward += 5.0  # Reward for stabilizing the cube
